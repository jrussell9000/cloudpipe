...
- `setup_auth.py` — retired stub. The login is `pixi run globus login` (see [globus-contract.md](globus-contract.md)); the file remains so older runbooks land on a signpost rather than a missing file.
